...
class Hoteis(Resource):
    def get(self):
        ...
        dados_validados = {chave:dados[chave] for chave in dados if dados[chave] is not None}
...
class Hotel(Resource):
    ...
    argumentos.add_argument('nome', type=str, required=True, \
        help="The field 'nome' is required.")
    argumentos.add_argument('estrelas', type=float, required=True, \
        help="The field 'estrelas' is required.")
    ...
    def put(self, hotel_id):
        ...
        try:
            ...
            return {'message': 'An internal error ocurred trying to save.'}
    ...
    def delete(self, hotel_id):
        ...
        if hotel:
            try:
                ...
                return {'messge': 'An error ocurred trying to delete hotel.'}, 500
